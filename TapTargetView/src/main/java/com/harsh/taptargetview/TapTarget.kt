...
/**
 * Describes the properties and options for a [TapTargetView].
 *
 *
...
open class TapTarget protected constructor(title: CharSequence?, description: CharSequence?) {
    ...
    var tintTarget = false
    var transparentTarget = false
    var descriptionTextAlpha = 0.54f

    protected constructor(bounds: Rect?, title: CharSequence?, description: CharSequence?): this(title, description) {
    ...
    /** Specify the color value for the outer circle  */ // TODO(Hilal): In v2, this API should be cleaned up / torched
    ...
    /** Specify the color value for the target circle  */ // TODO(Hilal): In v2, this API should be cleaned up / torched
    ...
    /** Specify the color value for all text  */ // TODO(Hilal): In v2, this API should be cleaned up / torched
    ...
    /** Specify the color value for the title text  */ // TODO(Hilal): In v2, this API should be cleaned up / torched
    ...
    /** Specify the color value for the description text  */ // TODO(Hilal): In v2, this API should be cleaned up / torched
    ...
    fun descriptionTextSize(sp: Int): TapTarget {
        if (sp < 0) throw IllegalArgumentException("Given negative text size")
    ...
    fun descriptionTextAlpha(descriptionTextAlpha: Float): TapTarget {
        if (descriptionTextAlpha < 0 || descriptionTextAlpha > 1f) {
            throw IllegalArgumentException("Given an invalid alpha value: $descriptionTextAlpha")
        }
    ...
    fun icon(icon: Drawable?, hasSetBounds: Boolean = false): TapTarget {
        if (icon == null) throw IllegalArgumentException("Cannot use null drawable")
        this.icon = icon
        if (!hasSetBounds) {
            this.icon!!.bounds = Rect(0, 0, this.icon!!.intrinsicWidth, this.icon!!.intrinsicHeight)
        }
        return this
    }
    ...
    fun bounds(): Rect {
        if (bounds == null) {
            throw IllegalStateException("Requesting bounds that are not set! Make sure your target is ready")
        }
    ...
    companion object {
         ...
         */
        @JvmOverloads
        fun forToolbarOverflow(toolbar: Toolbar?, title: CharSequence?,
            description: CharSequence? = null): TapTarget {
         ...
         */
        @JvmOverloads
        fun forToolbarOverflow(toolbar: android.widget.Toolbar?, title: CharSequence?,
            description: CharSequence? = null): TapTarget {
            return ToolbarTapTarget(toolbar, false, title, description)
        }
        ...
        /** Return a tap target for the navigation button (back, up, etc) from the given toolbar  */
        @JvmOverloads
        fun forToolbarNavigationIcon(toolbar: Toolbar?, title: CharSequence?,
            description: CharSequence? = null): TapTarget {
        ...
        /** Return a tap target for the navigation button (back, up, etc) from the given toolbar  */
        @JvmOverloads
        fun forToolbarNavigationIcon(toolbar: android.widget.Toolbar?, title: CharSequence?,
            description: CharSequence? = null): TapTarget {
            return ToolbarTapTarget(toolbar, true, title, description)
        }
        ...
        /** Return a tap target for the menu item from the given toolbar  */
        @JvmOverloads
        fun forToolbarMenuItem(toolbar: Toolbar?, @IdRes menuItemId: Int,
            title: CharSequence?, description: CharSequence? = null): TapTarget {
            return ToolbarTapTarget(toolbar, menuItemId, title, description)
        }
        /** Return a tap target for the menu item from the given toolbar  */
        /** Return a tap target for the menu item from the given toolbar  */
        @JvmOverloads
        fun forToolbarMenuItem(toolbar: android.widget.Toolbar?, @IdRes menuItemId: Int,
            title: CharSequence?, description: CharSequence? = null): TapTarget {
            return ToolbarTapTarget(toolbar, menuItemId, title, description)
        }
        ...
        /** Return a tap target for the specified view  */
        @JvmOverloads
        fun forView(view: View?, title: CharSequence?, description: CharSequence? = null): TapTarget {
            return ViewTapTarget(view, title, description)
        }
        /** Return a tap target for the specified bounds  */
        /** Return a tap target for the specified bounds  */
        @JvmOverloads
        fun forBounds(bounds: Rect?, title: CharSequence?, description: CharSequence? = null): TapTarget {
